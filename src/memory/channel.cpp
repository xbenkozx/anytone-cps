...
void Anytone::Channel::decode(QByteArray data_0, QByteArray data_1){
    rx_frequency = data_0.mid(0x0, 0x4).toHex().toInt();

    if(rx_frequency == 0){
        return;
    }

    offset = data_0.mid(0x4, 0x4).toHex().toInt();
    offset_direction = (static_cast<uint8_t>(data_0.at(0x8)) >> 6) & 0x3;
    band_width = (static_cast<uint8_t>(data_0.at(0x8)) >> 4) & 0x3;
    tx_power = (static_cast<uint8_t>(data_0.at(0x8)) >> 2) & 0x3;
    channel_type = (static_cast<uint8_t>(data_0.at(0x8))) & 0x3;

    talkaround = Bit::test(static_cast<unsigned char>(data_0.at(0x9)), 7);
    call_confirmation = Bit::test(static_cast<unsigned char>(data_0.at(0x9)), 6);
    ptt_prohibit = Bit::test(static_cast<unsigned char>(data_0.at(0x9)), 5);
    reverse = Bit::test(static_cast<unsigned char>(data_0.at(0x9)), 4);
    ctcss_dcs_encode = (static_cast<uint8_t>(data_0.at(0x9)) >> 2) & 0x3;
    ctcss_dcs_decode = (static_cast<uint8_t>(data_0.at(0x9))) & 0x3;
    ctcss_encode_tone = static_cast<uint8_t>(data_0.at(0xa));
    ctcss_decode_tone = static_cast<uint8_t>(data_0.at(0xb));
    dcs_encode_tone = Int::fromBytes(data_0.mid(0xc, 2));
    dcs_decode_tone = Int::fromBytes(data_0.mid(0xe, 2));
    tone2_decode = static_cast<uint8_t>(data_0.at(0x12));
    contact_idx = Int::fromBytes(data_0.mid(0x13, 2), Endian::Big);
    radio_id_idx = static_cast<uint8_t>(data_0.at(0x18));
    squelch_mode = (static_cast<uint8_t>(data_0.at(0x19)) >> 4) & 0x3;
    ptt_id = (static_cast<uint8_t>(data_0.at(0x19))) & 0x3;
    optional_signal = (static_cast<uint8_t>(data_0.at(0x1a)) >> 4) & 0x3;
    busy_lock = (static_cast<uint8_t>(data_0.at(0x1a))) & 0x3;
    scan_list_idx = static_cast<uint8_t>(data_0.at(0x1b));
    receive_group_call_list_idx = static_cast<uint8_t>(data_0.at(0x1c));
    tone2_id_idx = static_cast<uint8_t>(data_0.at(0x1d));
    tone5_id_idx = static_cast<uint8_t>(data_0.at(0x1e));
    dtmf_id_idx = static_cast<uint8_t>(data_0.at(0x1f));
    rx_color_code_idx = static_cast<uint8_t>(data_0.at(0x20));
    work_alone = Bit::test(static_cast<unsigned char>(data_0.at(0x21)), 7);
    aprs_rx = Bit::test(static_cast<unsigned char>(data_0.at(0x21)), 5);
    slot_suit = Bit::test(static_cast<unsigned char>(data_0.at(0x21)), 4);
    dmr_mode_dcdm = (static_cast<uint8_t>(data_0.at(0x21)) >> 2) & 0x3;
    time_slot = Bit::test(static_cast<unsigned char>(data_0.at(0x21)), 1);
    sms_confirmation = Bit::test(static_cast<unsigned char>(data_0.at(0x21)), 0);
    aes_encryption_idx = static_cast<uint8_t>(data_0.at(0x22));
    name = QString(data_0.mid(0x23, 0x10));
    
    auto_scan = Bit::test(static_cast<unsigned char>(data_0.at(0x34)), 4);
    data_ack_disable = Bit::test(static_cast<unsigned char>(data_0.at(0x34)), 3);
    exclude_channel_roaming = Bit::test(static_cast<unsigned char>(data_0.at(0x34)), 2);
    dmr_mode = Bit::test(static_cast<unsigned char>(data_0.at(0x34)), 1);
    ranging = Bit::test(static_cast<unsigned char>(data_0.at(0x34)), 0);
    aprs_report_type = static_cast<uint8_t>(data_0.at(0x35)); 
    analog_aprs_ptt_mode = static_cast<uint8_t>(data_0.at(0x36));
    digital_aprs_ptt_mode = static_cast<uint8_t>(data_0.at(0x37));
    digital_aprs_report_channel = static_cast<uint8_t>(data_0.at(0x38));
    correct_frequency = static_cast<uint8_t>(data_0.at(0x39));
    digital_encryption = static_cast<uint8_t>(data_0.at(0x3a));
    extend_encryption = Bit::test(static_cast<unsigned char>(data_0.at(0x3b)), 5);
    send_talker_alias = Bit::test(static_cast<unsigned char>(data_0.at(0x3b)), 4);
    analog_aprs_mute = Bit::test(static_cast<unsigned char>(data_0.at(0x3b)), 3);
    sms_forbid = Bit::test(static_cast<unsigned char>(data_0.at(0x3b)), 2);
    aes_random_key = Bit::test(static_cast<unsigned char>(data_0.at(0x3b)), 1);
    aes_multiple_key = Bit::test(static_cast<unsigned char>(data_0.at(0x3b)), 0);
    analog_aprs_report_frequency_idx = static_cast<uint8_t>(data_0.at(0x3c));
    arc4_encryption_key_idx = static_cast<uint8_t>(data_0.at(0x3d));

    r5tone_bot = static_cast<uint8_t>(data_1.at(0x0));
    r5tone_eot = static_cast<uint8_t>(data_1.at(0x1));
    tx_color_code_idx = static_cast<uint8_t>(data_1.at(0x3));
