...
void Anytone::AprsSettings::save(QDataStream &ds){
    ds << tx_freq_1;
    ds << tx_delay;
    ds << send_subtone;
    ds << ctcss;
    ds << dcs;
    ds << manual_tx_interval;
    ds << auto_tx_interval;
    ds << tx_tone;
    ds << fix_1_lat;
    ds << fix_1_ns;
    ...
    ds << prewave_time;
    ds << roaming_support;
    ds << repeater_activation_delay;
    ds << dis_time;
    ds << altitude;
    ds << pass_all;
    ds << sending_text ;
    ds << fixed_location_beacon;
    ds << analog_tx_mode;
    ds << filter_position;
    ds << filter_mic_e;
    ds << filter_object;
    ...
    ds << filter_message;
    ds << filter_wx_report;
    ds << filter_nmea_report;
    ds << filter_status_report;
    ds << filter_other;
    ds << digital_report_channel_1;
    ds << digital_report_channel_2;
    ds << digital_report_channel_3;
    ds << digital_report_channel_4;
    ds << digital_report_channel_5;
    ds << digital_report_channel_6;
    ds << digital_report_channel_7;
    ds << digital_report_channel_8;
    ds << digital_report_tg_1;
    ds << digital_report_tg_2;
    ds << digital_report_tg_3;
    ds << digital_report_tg_4;
    ds << digital_report_tg_5;
    ds << digital_report_tg_6;
    ds << digital_report_tg_7;
    ds << digital_report_tg_8;
    ds << digital_report_call_type_1;
    ds << digital_report_call_type_2;
    ds << digital_report_call_type_3;
    ds << digital_report_call_type_4;
    ds << digital_report_call_type_5;
    ds << digital_report_call_type_6;
    ds << digital_report_call_type_7;
    ds << digital_report_call_type_8;
    ds << digital_report_slot_1;
    ds << digital_report_slot_2;
    ds << digital_report_slot_3;
    ds << digital_report_slot_4;
    ds << digital_report_slot_5;
    ds << digital_report_slot_6;
    ds << digital_report_slot_7;
    ds << digital_report_slot_8;
    ds << fix_2_lat;
    ds << fix_2_lng;
    ds << fix_3_lat;
    ds << fix_3_lng;
...
void Anytone::AprsSettings::load(QDataStream &ds){
    ds >> tx_freq_1;
    ds >> tx_delay;
    ds >> send_subtone;
    ds >> ctcss;
