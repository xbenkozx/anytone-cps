...
void OptionalSettingsDialog::setupUI(){
    ...
    ui->fmWorkChannelCmbx->addItem("1");
    ui->fmMonitorCmbx->addItems(Constants::OFF_ON);

    // Key Function
    ui->keyLockCmbx->addItems(Constants::KEY_LOCK);
    ui->pf1ShortCmbx->addItems(Constants::KEY_FUNCTION);
    ui->pf2ShortCmbx->addItems(Constants::KEY_FUNCTION);
    ui->pf3ShortCmbx->addItems(Constants::KEY_FUNCTION);
    ui->p1ShortCmbx->addItems(Constants::KEY_FUNCTION);
    ui->p2ShortCmbx->addItems(Constants::KEY_FUNCTION);
    ui->pf1LongCmbx->addItems(Constants::KEY_FUNCTION);
    ui->pf2LongCmbx->addItems(Constants::KEY_FUNCTION);
    ui->pf3LongCmbx->addItems(Constants::KEY_FUNCTION);
    ui->p1LongCmbx->addItems(Constants::KEY_FUNCTION);
    ui->p2LongCmbx->addItems(Constants::KEY_FUNCTION);
...
void OptionalSettingsDialog::loadData(){
    ...
    ui->btOnOffCmbx->setCurrentIndex(Anytone::Memory::optional_settings->bt_on_off);
    ...
    ui->pf1ShortCmbx->setCurrentIndex(Anytone::Memory::optional_settings->pf1_short_key);
    ui->pf2ShortCmbx->setCurrentIndex(Anytone::Memory::optional_settings->pf2_short_key);
    ui->pf3ShortCmbx->setCurrentIndex(Anytone::Memory::optional_settings->pf3_short_key);
    ui->p1ShortCmbx->setCurrentIndex(Anytone::Memory::optional_settings->p1_short_key);
    ui->p2ShortCmbx->setCurrentIndex(Anytone::Memory::optional_settings->p2_short_key);
    ui->pf1LongCmbx->setCurrentIndex(Anytone::Memory::optional_settings->pf1_long_key);
    ui->pf2LongCmbx->setCurrentIndex(Anytone::Memory::optional_settings->pf2_long_key);
    ui->pf3LongCmbx->setCurrentIndex(Anytone::Memory::optional_settings->pf3_long_key);
    ui->p1LongCmbx->setCurrentIndex(Anytone::Memory::optional_settings->p1_long_key);
    ui->p2LongCmbx->setCurrentIndex(Anytone::Memory::optional_settings->p2_long_key);
...
void OptionalSettingsDialog::save(){
    ...
    Anytone::Memory::optional_settings->bt_on_off = ui->btOnOffCmbx->currentIndex();
    ...
    Anytone::Memory::optional_settings->pf1_short_key = ui->pf1ShortCmbx->currentIndex();
    Anytone::Memory::optional_settings->pf2_short_key = ui->pf2ShortCmbx->currentIndex();
    Anytone::Memory::optional_settings->pf3_short_key = ui->pf3ShortCmbx->currentIndex();
    Anytone::Memory::optional_settings->p1_short_key = ui->p1ShortCmbx->currentIndex();
    Anytone::Memory::optional_settings->p2_short_key = ui->p2ShortCmbx->currentIndex();
    Anytone::Memory::optional_settings->pf1_long_key = ui->pf1LongCmbx->currentIndex();
    Anytone::Memory::optional_settings->pf2_long_key = ui->pf2LongCmbx->currentIndex();
    Anytone::Memory::optional_settings->pf3_long_key = ui->pf3LongCmbx->currentIndex();
    Anytone::Memory::optional_settings->p1_long_key = ui->p1LongCmbx->currentIndex();
    Anytone::Memory::optional_settings->p2_long_key = ui->p2LongCmbx->currentIndex();
