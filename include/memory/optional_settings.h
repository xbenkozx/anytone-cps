...
namespace Anytone {
    ...
    public:
        ...
        // Key Function
        uint8_t key_lock = 0;
        uint8_t pf1_short_key = 0;
        uint8_t pf2_short_key = 0;
        uint8_t pf3_short_key = 0;
        uint8_t p1_short_key = 0;
        uint8_t p2_short_key = 0;
        uint8_t pf1_long_key = 0;
        uint8_t pf2_long_key = 0;
        uint8_t pf3_long_key = 0;
        uint8_t p1_long_key = 0;
        uint8_t p2_long_key = 0;
